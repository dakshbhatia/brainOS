...
struct BrainOSTests {
    ...
    @Test func router_health_and_root_endpoints() async throws {
        ...
        #expect(
            health.headers.contains {
                $0.0.lowercased() == "content-type" && $0.1.contains("application/json")
            }
        )
        ...
        #expect(root.body.contains("BrainOS Server is running"))
    }
