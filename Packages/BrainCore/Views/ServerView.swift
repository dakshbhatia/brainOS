...
//  BrainOS
//
//  Developer tools and API reference for building with BrainOS.
//
...
struct ServerView: View {
    ...
    private var endpointsSection: some View {
        VStack(alignment: .leading, spacing: 16) {
            ...
            Text("Available endpoints on your BrainOS server. GET endpoints can be tested directly.")
                .font(.system(size: 12))
                .foregroundColor(theme.secondaryText)
    ...
    private var documentationSection: some View {
        VStack(alignment: .leading, spacing: 12) {
            ...
            Text("Learn how to integrate BrainOS into your applications.")
                .font(.system(size: 12))
                .foregroundColor(theme.secondaryText)
    ...
    private func openDocumentation() {
        if let url = URL(string: "https://docs.BrainOS.ai/") {
