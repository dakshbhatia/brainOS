...
struct ThemesView: View {
    ...
    var body: some View {
        ...
        .fileImporter(
            ...
            allowedContentTypes: [.json, UTType(filenameExtension: "BrainOS-theme") ?? .json],
    ...
    private func performDelete(_ theme: CustomTheme) {
        ...
        if success {
            print("[BrainOS] Successfully deleted theme: \(themeName)")
            showSuccess("Deleted \"\(themeName)\"")
        } else {
            print("[BrainOS] Failed to delete theme: \(themeName)")
        }
        themeToDelete = nil
    }
    ...
    private func handleImport(_ result: Result<[URL], Error>) {
        ...
        case .success(let urls):
            ...
            do {
                ...
                print("[BrainOS] Failed to import theme: \(error)")
            }
        case .failure(let error):
            print("[BrainOS] Import failed: \(error)")
        }
    }
    ...
    private func handleExport(_ result: Result<URL, Error>) {
        ...
        case .success:
            ...
            themeToExport = nil
        case .failure(let error):
            print("[BrainOS] Export failed: \(error)")
        }
    }
}
