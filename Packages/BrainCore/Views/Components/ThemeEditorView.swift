...
struct ThemeEditorView: View {
    ...
    private func saveTheme() {
        ...
        print("[BrainOS] ThemeEditor: Saving theme '\(themeToSave.metadata.name)' (id: \(themeToSave.metadata.id))")
        ...
        print("[BrainOS] ThemeEditor: Theme saved and applied successfully")
    ...
    private func handleImageImport(_ result: Result<[URL], Error>) {
        ...
        case .success(let urls):
            ...
            do {
                ...
                print("[BrainOS] Failed to import image: \(error)")
            }
        case .failure(let error):
            print("[BrainOS] Image import failed: \(error)")
        }
    }
}
