...
enum ChatSessionStore {
    ...
    static func loadAll() -> [ChatSessionData] {
        ...
        for file in files where file.pathExtension == "json" {
            do {
                ...
                print("[BrainOS] Failed to load session from \(file.lastPathComponent): \(error)")
            }
        }
    ...
    static func load(id: UUID) -> ChatSessionData? {
        ...
        do {
            ...
            print("[BrainOS] Failed to load session \(id): \(error)")
            return nil
        }
    }
    ...
    static func save(_ session: ChatSessionData) {
        ...
        do {
            ...
            print("[BrainOS] Failed to save session \(session.id): \(error)")
        }
    }
    ...
    static func delete(id: UUID) {
        ...
        do {
            ...
            print("[BrainOS] Failed to delete session \(id): \(error)")
        }
    }
