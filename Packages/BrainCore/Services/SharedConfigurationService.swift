...
final class SharedConfigurationService {
    ...
    private func ensureDirectories() -> URL? {
        ...
        do {
            ...
            print("[BrainOS] SharedConfigurationService: failed to create directories: \(error)")
            return nil
        }
    }
    ...
    func update(health: ServerHealth, configuration: ServerConfiguration, localAddress: String) {
        ...
        case .running:
            ...
            do {
                ...
                print("[BrainOS] SharedConfigurationService: failed to write configuration: \(error)")
            }
        case .starting:
            ...
            do {
                ...
                print(
                    "[BrainOS] SharedConfigurationService: failed to write starting configuration: \(error)"
                )
            }
        case .restarting:
            ...
            do {
                ...
                print(
                    "[BrainOS] SharedConfigurationService: failed to write restarting configuration: \(error)"
                )
            }
    ...
    func remove() {
        ...
        do {
            if FileManager.default.fileExists(atPath: instance.path) {
                ...
                print(
                    "[BrainOS] SharedConfigurationService: removed instance directory at \(instance.path)"
                )
            }
        } catch {
            print("[BrainOS] SharedConfigurationService: failed to remove instance directory: \(error)")
        }
    }
}
