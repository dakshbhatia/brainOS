...
//  BrainOS
//
//  Command to stop the running BrainOS server via distributed notification.
//
...
public struct StopCommand: Command {
    ...
    public static func execute(args: [String]) async {
        AppControl.postDistributedNotification(name: "com.dinoki.BrainOS.control.stop", userInfo: [:])
