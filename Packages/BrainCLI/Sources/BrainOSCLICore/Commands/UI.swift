...
//  BrainOS
//
//  Command to show the BrainOS menu bar popover UI by sending a distributed notification to the app.
//
    ...
    public static func execute(args: [String]) async {
        ...
        while Date() < deadline {
            ...
            if await ServerControl.checkHealth(port: port) {
                AppControl.postDistributedNotification(name: "com.dinoki.BrainOS.control.ui", userInfo: [:])
